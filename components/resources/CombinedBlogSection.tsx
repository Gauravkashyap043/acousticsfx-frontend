        ...
        <div className="w-full py-10 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 md:px-6">
                <div className="flex flex-col lg:flex-row justify-start gap-6 lg:gap-8">
                    ...
                    <div
                        className="border border-gray-300 rounded-lg bg-white p-4 lg:p-6 flex-shrink-0"
                        style={{ 
                            width: "100%",
                            maxWidth: "calc(60% - 1rem)",
                            minWidth: "300px",
                            height: "auto",
                            minHeight: "448.76px"
                        }}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-full">
                    {/* Big Featured Area - 2 columns */}
                    <div className="md:col-span-2 flex flex-col justify-start">
                        {/* Big Image */}
                        <div
                            className="overflow-hidden rounded-md w-full"
                            style={{ maxWidth: "100%", height: "auto", minHeight: "180px", aspectRatio: "493/237" }}
                        >
                            <Image
                ...
                border-b border-gray-900 hover:border-blue-600 pb-0.5 w-fit transition"
                            >
                                View Post
                            </button>
                        </div>
                    ...
                    {/* Small Posts Right Inside Left Card */}
                        ...
                        {[
                            ...
                            <div key={index} className="flex gap-4 items-start">
                                <div
                                    ...
                                    style={{ width: "100px", minWidth: "100px", height: "70px", maxWidth: "118.35px" }}
                                >
                                    <Image
                                        src={item.img}
                                        alt={item.title}
                ...
                <div className="space-y-8">
                    {[
                        ...
                        <div key={i} className="flex gap-4">
                            <div
                                className="overflow-hidden rounded-md flex-shrink-0"
                                style={{ width: "180px", minWidth: "180px", height: "85px", maxWidth: "222.09px" }}
                            >
                                <Image
                                    src={src}
                                    alt="read"
