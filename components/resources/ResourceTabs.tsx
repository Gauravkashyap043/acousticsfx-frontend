...
export default function ResourceTabs({ activeTab: propActiveTab }: ResourceTabsProps) {
    ...
    // Get active tab from URL query parameter, default to 'blogs'
    ...
    // Handle tab click - update URL without page reload
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-full relative">
          ...
          >
            ...
            <h1
              className="font-manrope text-[26px] md:text-[44px] text-[#1C1C1C] leading-snug"
              data-aos="fade-up"
              data-aos-delay="200"
            >
          ...
          <div
            ...
            data-aos-delay="300"
          >
            <div className="relative w-[340px] h-[270px] md:w-[900px] md:h-[700px]">
              <Image
