...
export default function BlogArticlesHero({ blogTitle, isDetailPage = false, heroImage }: BlogArticlesHeroProps = {}) {
    ...
    return (
        <div className="w-full relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px]">
            <Swiper
            ...
            >
                {slides.map((slide, index) => (
                    <SwiperSlide key={index}>
                        ...
                        >
                            {/* HERO SECTION */}
                            <div className="max-w-7xl mx-auto px-4 md:px-6 h-full relative flex flex-col justify-center items-center">
            ...
            {!isDetailPage && (
                <div className="absolute bottom-0 left-0 right-0 flex justify-center pb-4">
                    <div className="bg-[#F5F5FF] border border-[#ffff] border-solid border-6 rounded-t-lg shadow-md p-2 inline-flex gap-6">
                        <button
            ...
            {!isDetailPage && (
                <button className="absolute right-[-37px] top-1/2 -translate-y-1/2 bg-[#0052CC] text-white px-4 py-2 text-sm font-medium rotate-90 rounded-b-lg shadow-lg z-10">
                    Enquire Now
                </button>
            )}
        </div>
